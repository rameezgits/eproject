        ...
        <div>
            ...
            <section class="about-section">
                <div class="auto-container">
                    <div class="row">
                        ...
                        <div class="content-column col-xl-6 col-lg-6 order-lg-2 wow fadeInRight animated" data-wow-delay="600ms" style={{visibility: 'visible', animationDelay: '600ms', animatioName: 'fadeInRight'}}>
                        ...
                        <div class="image-column col-xl-6 col-lg-6">
                            <div class="inner-column wow fadeInLeft animated" style={{visibility: 'visible',  animatioName: 'fadeInLeft'}}>
                                <figure class="image-1 overlay-anim wow fadeInUp animated" style={{visibility: 'visible',  animatioName: 'fadeInUp'}}><img src="images/resource/about1-1.jpg" alt="" /></figure>
                                <figure class="image-2 overlay-anim wow fadeInLeft animated" style={{visibility: 'visible',  animatioName: 'fadeInLeft'}}><img src="images/resource/about1-2.jpg" alt="" /></figure>
                                <figure class="image-4 overlay-anim wow fadeInLeft animated" style={{visibility: 'visible',  animatioName: 'fadeInLeft'}}><img src="images/resource/icon-1.png" alt="" /></figure>
                                <figure class="image-5 bounce-y overlay-anim wow fadeInLeft animated" style={{visibility: 'visible',  animatioName: 'bounce-y'}}><img src="images/resource/icon-6.png" alt="" /></figure>
                                <div class="btn-box">
                ...
                <div class="auto-container">
                    <div class="row">
                        <div class="image-column col-xl-4 col-lg-4">
                            <div class="inner-column">
                                <div class="image-box">
                                    <figure class="image wow fadeInUp animated" style={{visibility: 'visible',  animatioName: 'fadeInUp'}}><img src="images/resource/food-1.jpg" alt="" /></figure>
                                </div>
                ...
                <div class="auto-container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 booking-form-column">
                            <div class="inner-column wow fadeInRight animated" data-wow-delay="200ms" style={{visibility: 'visible', animationDelay: '200ms', animatioName: 'fadeInRight'}}>
                    ...
                    <div class="row">
                        ...
                        <div class="client-block col-lg-4 col-sm-6">
                            <div class="inner-box wow fadeInLeft animated" style={{visibility: 'visible', animatioName: 'fadeInLeft'}}>
                                ...
                                <div class="image-box">
                                    <figure class="image wow fadeInUp animated" style={{visibility: 'visible', animatioName: 'fadeInUp'}}><img src="images/resource/client.jpg" alt="" /></figure>
                        ...
                        <div class="client-block col-lg-4 col-sm-6">
                            <div class="inner-box wow fadeInLeft animated" data-wow-delay="200ms" style={{visibility: 'visible', animationDelay: '200ms', animatioName: 'fadeInLeft'}}>
                                ...
                                <span>Founder of Webflex</span>
                                <div class="image-box">
                                    <figure class="image wow fadeInUp animated" style={{visibility: 'visible', animatioName: 'fadeInUp'}}><img src="images/resource/client-2.jpg" alt="" /></figure>
                                    <i class="icon fa fa-circle-check"></i>
                                </div>
                                <div class="text">Upon they're seasons green day beast<br />without form man be firmament years shall<br />the appear moveth signs had.</div>
                            </div>
                        ...
                        <div class="client-block col-lg-4 col-sm-6">
                            <div class="inner-box wow fadeInLeft animated" data-wow-delay="300ms" style={{visibility: 'visible', animationDelay: '300ms', animatioName: 'fadeInLeft'}}>
                                <h4 class="title">Robotor Doses</h4>
                                <span>Founder of Webflex</span>
                                <div class="image-box">
                                    <figure class="image wow fadeInUp animated" style={{visibility: 'visible', animatioName: 'fadeInUp'}}><img src="images/resource/client-3.jpg" alt="" /></figure>
                                    <i class="icon fa fa-circle-check"></i>
                                </div>
                                <div class="text">Upon they're seasons green day beast<br />without form man be firmament years shall<br />the appear moveth signs had.</div>
                            </div>
            ...
            <section class="about-section">
                <div class="auto-container">
                    <div class="row">
                        ...
                        <div class="content-column col-xl-6 col-lg-6 order-lg-2 wow fadeInRight animated" data-wow-delay="600ms" style={{ visibility: 'visible', animationDelay: '600ms' }}>
                            <div class="inner-column">
                                <div class="sec-title">
                                    <span class="sub-title">Hoexr Luxury Hotel</span>
                                    <h2>Most Safe &amp; Rated <br />Hotel in London.</h2>
                        ...
                        <div class="image-column col-xl-6 col-lg-6">
                            <div class="inner-column wow fadeInLeft animated" style={{visibility: 'visible', animatioName: 'fadeInLeft'}}>
                                ...
                                <figure class="image-2 overlay-anim wow fadeInLeft animated" style={{visibility: 'visible', animatioName: 'fadeInLeft'}}><img src="images/resource/about1-2.jpg" alt="" /></figure>
                                <figure class="image-4 overlay-anim wow fadeInLeft animated" style={{visibility: 'visible', animatioName: 'fadeInLeft'}}><img src="images/resource/icon-1.png" alt="" /></figure>
                                <figure class="image-5 bounce-y overlay-anim wow fadeInLeft animated" style={{visibility: 'visible', animatioName: 'bouncy-y'}}><img src="images/resource/icon-6.png" alt="" /></figure>
                                <div class="btn-box">
                                    <a href="https://www.youtube.com/watch?v=Fvae8nxzVz4" class="play-now-two" data-fancybox="gallery" data-caption="">
                                        <i class="icon fa fa-play" aria-hidden="true"></i>
                                        <span class="ripple"></span>
            ...
            <section class="call-to-action pt-0">
                <div class="auto-container">
                    <div class="row">
                        <div class="content-colum col-lg-6 col-md-12 col-sm-12">
                            <div class="inner-column wow fadeInLeft animated" style={{visibility: 'visible'}}>
                                <div class="sec-title"> <span class="sub-title">Call to action</span>
                                    <h2>The Thin Escape.</h2>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="client-block col-lg-4 col-sm-6">
                                    <div class="inner-box wow fadeInLeft animated" data-wow-delay="200ms" style={{visibility: 'visible', animationDelay: '200ms', animatioName: 'fadeInLeft'}}>
                                        ...
                                        <span>Founder of Webflex</span>
                                        <div class="image-box">
                                            <figure class="image wow fadeInUp animated" style={{visibility: 'visible', animatioName: 'fadeInLeft'}}><img src="images/resource/client-2.jpg" alt=""/></figure>
                                            <i class="icon fa fa-circle-check"></i>
                                        </div>
                                        <div class="text">Upon they're seasons green day beast<br />without form man be firmament years shall<br />the appear moveth signs had.</div>
                                    </div>
